...
public final class MonetaryFormat {
    ...
    public static final String CODE_BTC = "NB";
    /** Currency code for base 1/1000 Bitcoin. */
    public static final String CODE_MBTC = "mNB";
    /** Currency code for base 1/1000000 Bitcoin. */
    public static final String CODE_UBTC = "µNB";
    /** Currency symbol for base 1 Bitcoin. */
    public static final String SYMBOL_BTC = "NB";//\u20bf
