...
public class BitcoinURI {
     ...
     */
    @Deprecated
    public static final String BITCOIN_SCHEME = "newbull";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the newbull: prefix");
    ...
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws BitcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (sepIndex == -1)
                throw new BitcoinURIParseException("Malformed NewBull URI - no separator in '" +
                        nameValuePairToken + "'");
            if (sepIndex == 0)
                throw new BitcoinURIParseException("Malformed NewBull URI - empty name '" +
                        nameValuePairToken + "'");
    ...
    public String toString() {
        StringBuilder builder = new StringBuilder("NewBullURI[");
        boolean first = true;
