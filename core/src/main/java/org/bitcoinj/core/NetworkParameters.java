...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.newbull.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.newbull.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.newbull.regtest";
    /** Unit test network. */
    ...
    protected Block genesisCheckpointBlock;
    ...
    protected NetworkParameters() {
        ...
        genesisCheckpointBlock=createCheckpointGenesis(this);
    }
...
//            t.addOutput(new TransactionOutput(n, t, FIFTY_COINS, scriptPubKeyBytes.toByteArray()));
            t.addOutput(new TransactionOutput(n, t, COIN.multiply(1048576000L), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
    ...
    //https://explorer.newbull.org/block/300000
    //0000000a4a23d51296fe5948b8b2744134b11463b1606e6e28ca0622366af7b9
    private static Block createCheckpointGenesis(NetworkParameters n) {
        Transaction t = new Transaction(n);
        try {
            // A script containing the difficulty bits and the following message:
            //
...
//            System.out.println(Utils.HEX.encode("The New York Times June 25, 2016 BREXIT SETS OFF A CASCADE OF AFTERSHOCKS".getBytes()));
            ...
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptPubKeyBytes, Utils.HEX.decode
                    ("02740868deee9042a76fcecc69fd7eaadd5e85ba6a4f77ed5648392f901e905b02"));
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
//            t.addOutput(new TransactionOutput(n, t, FIFTY_COINS, scriptPubKeyBytes.toByteArray()));
            t.addOutput(new TransactionOutput(n, t, COIN.multiply(128000L), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
            throw new RuntimeException(e);
        }
        ...
        Block genesisBlock = new Block(
                n,
                Block.BLOCK_VERSION_BIP66,
                Sha256Hash.wrap("000000f392442aee306d11be927f6c34be829ebcafaaa4fe645df7889f9f4cf0"),
                Sha256Hash.wrap("f7d6e43d8fe3ddcde44144cdee340845b8a60972745d4377af91e12dce3f8208"),
                1541470033L,
                0x1e012f76L,
                3573025536L,
                transactions
...
//        genesisBlock.addTransaction(t);
     ...
     */
    public static final long MAX_COINS = 21000000000L;
    ...
    public Block getGenesisCheckpointBlock() {
        return genesisCheckpointBlock;
    }
