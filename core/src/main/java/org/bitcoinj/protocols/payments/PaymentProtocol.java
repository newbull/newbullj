...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/newbull-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/newbull-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/newbull-paymentack";
