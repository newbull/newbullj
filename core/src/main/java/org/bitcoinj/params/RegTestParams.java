...
//        checkState(genesisHash.equals("00000007199508e34a9ff81e6ec0c477a4cccff2a4767a8eee39c11db367b008"));
        ...
        genesisBlock.setNonce(3);
        spendableCoinbaseDepth = 100;
        String genesisHash = genesisBlock.getHashAsString();
        checkState(genesisHash.equals("05c660a19b17c141e739eccab6c2aade26726c991162ec469c7dca67ad24af91"));
...
//                checkState(genesis.getHashAsString().toLowerCase().equals("0f9188f13cb7b2c71f2a335e3a4fc328bf5beb436012afca590b1a11466e2206"));
                genesis.setNonce(3);
                genesis.setDifficultyTarget(0x207fFFFFL);
                genesis.setTime(1466861400L);
                checkState(genesis.getHashAsString().toLowerCase().equals("05c660a19b17c141e739eccab6c2aade26726c991162ec469c7dca67ad24af91"));
            }
            return genesis;
        }
    }
